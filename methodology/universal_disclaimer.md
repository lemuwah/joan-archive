...
**Purpose:** Reusable disclaimer block for all people pages, context pages, and analysis pages.
**Added:** 2026-09-07 (Task 2)
**Status:** Finalized by archive owner
**Usage:** Include at the top of every page in `/people/`, `/context/`, and any page that discusses individual lives.
...
Copy the blockquote above into the `## Disclaimer` section of any page that follows the universal page format (Task 4).

For HTML pages (`index.html`, `analysis.html`, `context.html`, `about.html`), render as a styled callout or banner.
