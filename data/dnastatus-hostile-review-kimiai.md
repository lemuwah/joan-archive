## HOSTILE REVIEW: Gemini Claims vs. Raw FTDNA Green/Greene Project Data

**Data source:** 4-page public Y-DNA results dump from `familytreedna.com/public/Green`  
**Date of dump:** 7/28/2026
**Method:** Direct string extraction from raw tab-delimited project data. No interpolation.
CLAIM 1: "The Quidnessett line is anchored in R-BY186325"
VERDICT: MISLEADING.
The Quidnessett R-Z156 section contains 15 kits. Here is the exact haplogroup distribution from the raw data:
Table
Kit	Surname	Ancestor	Haplogroup	Test
15636	Green	(blank)	R-M269	Y-DNA25
125613	Greene	John Greene, Rhode Island, 1638	R-M269	Y-DNA12
166769	Greene	John Greene, Quidnesset, Rhode Island	R-FTG9921	Big Y-700
8023	Green	(blank)	R-M269	Y-DNA25
219979	Green	John Greene of Quidnessett	R-Z156	Family Finder
B819637	Ristau	John Greene of Quidnessett	R-FTG9921	Big Y-700
154581	Stahl	(blank)	R-M269	Y-DNA67
473923	Greene	Samuel Green, b. 1759, d. 1822 NY	R-M269	Y-DNA111
N61285	Green	John Green(e) of Quidnessett, b. 1609, d. 1695	R-Z156	Backbone SNP Pack
172964	Green	(blank)	R-BY186325	Big Y-500
144494	Smith	(blank)	R-M269	Y-DNA37
168649	Green	John Greene of Quidnessett	R-M269	Y-DNA37
666416	Green	John Greene, of Quidnessette	R-Z156	Family Finder
2162	Green	George Green	R-U106	Family Finder
262156	Green	(blank)	R-M269	Y-DNA37
Only 1 kit (172964) is confirmed R-BY186325. It has no ancestor name listed. Two kits (166769, B819637) are confirmed R-FTG9921 — a different terminal SNP — and both explicitly name "John Greene of Quidnessett" as ancestor. The majority are predicted R-M269 or R-Z156 with low-resolution tests.
R-BY186325 is not the dominant confirmed haplogroup in the Quidnessett group. R-FTG9921 has better paper-trail support.
CLAIM 2: "Descendants of Benjamin Greene (m. Humility Coggeshall) and Henry Greene carry confirmed R-BY186325 signatures"
VERDICT: COMPLETELY UNSUPPORTED. FICTION.
I searched the entire 4-page dump for every variant of these names. Here is what exists:
"Benjamin Greene" (son of John of Quidnessett, m. Humility Coggeshall):
Zero matches. No kit in the entire project lists this man as a paternal ancestor.
The word "Benjamin" appears 5 times in the entire file, all unrelated:
859481 Benjamin Green, 1755–1833, I-FT236005 (I-M253 branch — completely wrong haplogroup)
306047 Benjamin Green? ~1820 Latvia, Q-BZ28 (wrong haplogroup, wrong continent)
320061 Benjamin Green, 1751–1781, R-L151 (Family Finder only, no Y-SNPs)
1010853 Benjamin Franklin Greene, 1761–1850, R-BY136048 (L2 branch — wrong haplogroup)
248152 Benjamin M Simmons, 1820 NC, R-FTB16942 (L21 branch — wrong haplogroup)
"Henry Greene" (son of John of Quidnessett):
Zero matches. No kit lists Henry Greene, son of John of Quidnessett, as ancestor.
The word "Henry" appears in 12 kits, all in unrelated branches:
Henry Frank Green b. 1835 Ohio (R-M269 predicted, ZP163 branch)
Henry Green d. 1810 NC (R-Z25289, Z8 branch)
Henry S. Green c. 1820 (R-M269, U198 branch)
Henry Filmer Green 1662–? (R-M269 predicted, L2 branch)
Henry Green b. ~1700 Lunenburg VA (R-FTA59528, L2 branch)
Henry Washington Green b. ~1807 NC (R-L2)
Henry Green b. 1778 England (R-M269 predicted, general group)
etc.
None are in the R-Z156 Quidnessett section. None are R-BY186325. None are R-FTG9921.
The claim that Benjamin and Henry descendants "carry confirmed R-BY186325 signatures" is unverifiable from this data and likely hallucinated. The one R-BY186325 kit (172964) is anonymous.
CLAIM 3: "Testing living direct male-line descendants of John Jr. (1651–1729) or Edward will pinpoint the precise SNP mutation"
VERDICT: CONTRAINDICATED. DEAD END.
There are two kits claiming John Jr. (1651–1729, m. Abigail Wardwell) ancestry. They contradict each other:
Kit 88120 — Green, "NPE - STREETER, John & Abigail (Wardwell) GREEN"
Haplogroup: R-BY53596 (Big Y-700)
Section: U106 > Z381 > Z301 > L48 > Z9 > Z30 > Z27 > Z345 > Z2 > Z7 > Z8
Explicitly labeled NPE (Non-Paternal Event) — Streeter line
STR modal values differ from Quidnessett R-Z156 at multiple markers
Kit 223975 — Fuller, "John Greene, abt. 1651 – 1729 m Abigail Wardwell"
Haplogroup: R-M269 (predicted, Y-DNA37 only)
Section: General R-M269 "Relatives of" (NOT the Quidnessett R-Z156 group)
Modal STR comparison to Quidnessett R-Z156:
DYS390: 23 vs 24 (differs)
DYS389ii: 28 vs 29 (differs)
DYS385: 11-14 vs 11-13 (differs)
DYS447: 25 vs 24 (differs)
DYS464: 15-15-16-18 vs 14-15-17-17 (differs)
Neither kit is in the Quidnessett R-Z156 section. Neither matches the Quidnessett modal haplotype. Kit 88120 is an explicit NPE. Kit 223975 is low-resolution and in the wrong haplogroup cluster.
There are NO kits listing Edward Greene (son of John of Quidnessett) as ancestor anywhere in the 4-page dump.
Using John Jr. descendants to "pinpoint SNP mutations" within the Quidnessett line is impossible with current project data. The branch is either an NPE or genetically unrelated to the R-Z156 core.
CLAIM 4: "Target adjacent sub-clades R-FT273431 / R-FTB79899"
VERDICT: PHANTOM SNPs. NOT FOUND.
String search of the entire 4-page dump:
Table
SNP	Occurrences
FT273431	0
FTB79899	0
These SNPs do not appear anywhere in the Green/Greene project public results. They may exist on the broader Y-tree, but no project member has been assigned these haplogroups. Targeting them is meaningless without a confirmed tester.
The only confirmed downstream SNPs in the Quidnessett vicinity are R-FTG9921 (2 kits, Big Y-700) and R-BY186325 (1 kit, Big Y-500).
CLAIM 5: "FTDNA Subgroup C6"
VERDICT: NOT VISIBLE IN PUBLIC DATA.
The string "C6" appears zero times in the 4-page dump. The public results are organized by haplogroup tree (R-M207 > M173 > L754 ... > R-Z156), not by numbered subgroups. Subgroup labels like "C6" may exist in project-admin-only views or older iterations, but they are not present in the data you provided.
CLAIM 6: "Surgeon John Greene belongs to haplogroup I-M223"
VERDICT: CONFIRMED.
Multiple kits in the I-M223 section trace to Surgeon John Greene:
Table
Kit	Surname	Ancestor	Haplogroup	Test
59360	Spencer	John Greene, the Surgeon, born 1585	I-FTD6960	Big Y-700
140770	Greene	James Greene b. 1750 d. 1818	I-M170	Y-DNA37
336906	Goen (GREENE)	Richard Greene b. ca. 1550 d. 1608	I-M170	Y-DNA37
320281	Greene	(blank)	I-FTC61816	Big Y-700
