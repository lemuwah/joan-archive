...
| R2 | **The James instrument recording page** inside DGS 008204949 (444 images, 4 read) | James's deed may word the Joan clauses differently than Daniel's | **2026-09-09 in-house result:** the volume's INDEX is on Image 9 left — the Greene rows would hand us the page number, but they're illegible at current scan resolution; Worth 1921 pp. 173–174 is the only James text in hand (read already on file). **Access re-tested 2026-09-09: the film could not be browsed from this environment — human FamilySearch session required.** Next: hi-res Image 9 index, or sequential sweep from Image 13 | 🟡 PARTIAL — blocker identified (index legibility); remote access blocked, human step required |
