# 1682 Home-Place Deed & Pawtuxet Consent — Documentary Lifecycle Matrix
**Target Instruments:** 
1. Home-Place Land Division (24 March 1681/82)  
...
**Status:** Tier 1 / Proven Primary Text (ONE explicit legal appearance in 1682 — the home-place deed. Second appearance SUSPENDED.)

---

## ⚠️ REVISION NOTICE (2026-08-31)

The Pawtuxet deed (Node 3 below) has been **SUSPENDED** following an exhaustive search of digitized primary sources. The verbatim text of a deed dated 19 May 1682 from John Greene to William Carpenter for £10 with Joan's consent was NOT found in:
- RI Land Evidences Vol. I (Worth) — Internet Archive
- Early Records of the Town of Warwick (Chapin 1926) — Internet Archive (380 pages)
- History & Genealogy of the Carpenter Family
- Early Records of the Town of Providence
- Bartlett Colony Records Vol. III (1678–1706)

The closest matching record is the **1658 deed** from "John Greene Junr Warwick" to William Carpenter (Pawtuxet land, verified verbatim). The **only verified 1682 deed naming Joan** is the March 24, 1681/82 home-place partition.

See theory/proof_pieces/09_pawtuxet_problem.md for full search documentation.

Per Law 1: The deed is not deleted. It is suspended pending physical archive verification.

---

## Nine-Node Lifecycle Matrix

[Node 1: Estate Partition Planning]
│
▼
[Node 2: Home-Place Execution (24 March 1681/82)] ──> [Life-Estate Clause Inserted]
│
▼
...
│
▼
[Node 6: Post-Mortem Possession & Life-Estate Trigger] ──> [Sons' Possession / Dower]
│
▼
[Node 7: Subsequent Son-to-Son Deeds & Sales] ──> [Daniel & James Chain of Title]
│
▼
[Node 8: Quidnessett Cartographic Confirmation (1717/18)] ──> [151 Ac Plat Map]
│
▼
[Node 9: Genealogical Transcription & Publication (1894–Present)]
...
## Node 3: Pawtuxet Sale Consent (19 May 1682) — **SUSPENDED**
* **Previous status:** PROVEN
* **Current status:** **UNVERIFIED — verbatim text not located**
* **Administrative Context (as previously understood):** Sale of Pawtuxet land rights to William Carpenter for £10.
* **What was claimed:**
...
## Nodes 4–9: Unchanged from original
*(See git history for full original text of Nodes 4–9)*

---

## Priority Archival Search Targets (Updated)

| Target ID | Target Record | Target Repository | Objective |
|---|---|---|---|
