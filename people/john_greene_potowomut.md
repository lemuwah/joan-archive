...
##Potowomut John
You left this blank—good, that’s honest.

Baby‑step note (for now):

What I know: essentially nothing I trust yet; Potowomut may be:

a location label reused by later compilers, or

a real distinct John whose trail isn’t yet built.

Status: 
##UNRESOLVED PERSON SLOT — keep him as a placeholder, no data attached. 
action needs defining logic.
