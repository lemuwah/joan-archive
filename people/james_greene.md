...
1. NK Land Records (DGS 008204949) — find the James instrument recording page (444 images, we've read 4)
2. NK Land Records grantor/grantee index — search "James Greene"
3. James & Elizabeth → John Corey deed — full text
4. Elizabeth's maiden name — church, vital, or probate records
5. NK/Kingstown probate records for James
